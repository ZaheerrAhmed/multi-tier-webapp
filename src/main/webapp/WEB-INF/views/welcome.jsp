    ...
    <div class="row">
                ...
                <nav class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Zaheer Ahmad</a>
                        </div>
                        <!-- Navbar Links -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@zaheerahmad.dev
                                                        </p>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>DevOps Engineer specializing in cloud-native infrastructure, CI/CD automation, Kubernetes, Terraform, and multi-region disaster recovery. Building 100 real-world DevOps projects.</p>
                            <hr>
                            <h3><strong>Location</strong></h3>
                            <p>Pakistan</p>
                            <hr>
                            <h3><strong>Skills</strong></h3>
                            <p>AWS · Azure · Kubernetes · Terraform · ArgoCD · Jenkins · Docker · Ansible · Prometheus</p>
                            <hr>
                            <h3><strong>GitHub</strong></h3>
                            <p><a href="https://github.com/ZaheerrAhmed">ZaheerrAhmed</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@zaheerahmad.dev</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
                      ...
                      <%
                          ...
                          String username = auth != null ? auth.getName() : "to Zaheer Ahmad DevOps Platform";
                      %>
